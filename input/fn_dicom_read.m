function [lung_img_3d nodule_img_3d dicom_tags thick pixelsize, nodule_info, cc] = fn_dicom_read(ipath,pid)
...
lung_img_3d = ones(512,512,num) * -2000; % for mathching HU field.
